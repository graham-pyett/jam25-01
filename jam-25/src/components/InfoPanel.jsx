...
const InfoPanel = ({ bag, swaps, turn, turns, money}) => {
  return (
    <Box sx={{ backgroundColor: 'dimgrey', color: 'white', p: 2, borderRadius: '8px', border: '1px solid ghostwhite', width: 120, mr: 2, display: 'flex', flexDirection: 'column', alignItems: 'flex-start', justifyContent: 'center' }}>
